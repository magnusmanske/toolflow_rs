...
impl HeaderMapping {
    pub fn add_plain_text(&mut self, source_column: &str, header_label: &str) {
    ...
    pub fn add_wikidata_item(&mut self, source_column: &str, header_label: &str) {
        self.data.push(ColumnMapping{
    ...
    pub fn add_wiki_page(&mut self, source_column: &str, header_label: &str, wiki_page: &WikiPage) {
        self.data.push(ColumnMapping{
